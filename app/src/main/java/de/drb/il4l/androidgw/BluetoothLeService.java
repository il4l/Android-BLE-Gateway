...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_HEART_RATE_MEASUREMENT =
            TagGattManager.RANGING_SERVICE;
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                battery_service = mBluetoothGatt.getService(BATTERY_SERVICE);
                if (battery_service != null) {
                    mBatLevel = battery_service.getCharacteristic(BATTERY_LEVEL);

                    if(mBatLevel != null){
                        mBatLevel.setWriteType(BluetoothGattCharacteristic.WRITE_TYPE_DEFAULT);
                        setCharacteristicNotification(mBatLevel, true);
                    }
                }
            } else {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            System.out.println("changed the characteristic .... new ...");
        }

        @Override
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor,
                                      int status) {
            System.out.println("changed the descriptor .... new ...");
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        boolean ret1 = mBluetoothGatt.setCharacteristicNotification(characteristic, enabled);

        BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                CONFIG_DESCRIPTOR);
        boolean ret2 = descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
        boolean ret3 = mBluetoothGatt.writeDescriptor(descriptor);
        Log.d(TAG, "setCharacteristicNotification ret1:"+ret1+" ret2:"+ret2+" ret3:"+ret3);
    }
